...
/**
 * The CardPile class models a pile of playing cards. The maximum number of cards allowed in the
 * pile is determined when the class is initialised. Operations are provided that allow a Card to be
 * added and removed from the card pile.
 */
