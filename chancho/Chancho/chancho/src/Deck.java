/**
 * Interface for a deck of playing cards. Single cards may only be added to the bottom of the deck
 * and removed from the top. Two card shuffling operations are defined on any deck: the cut and the
 * riffle-shuffle. Some standard operations to query the size of the Deck are also made available.
 */
