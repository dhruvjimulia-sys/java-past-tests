...
/**
 * This class provides the entry-point to the Chancho game. The class is responsible for:
 *
 * <p>-- creating players, organising them in a circle and allocating card-piles between each
 * player.
 *
 * <p>-- creating a Chancho game-deck of the appropriate size.
 *
 * <p>-- shuffling the game-deck.
 *
 * <p>-- creating a game dealer.
 *
 * <p>-- instructing the game dealer to begin the game.
 */
public final class Chancho {
  ...
  /**
   * Create a game-deck with 'size' cards, by adding complete sets of suit-values for each
   * rank-value in ascending order of rank.
   */
