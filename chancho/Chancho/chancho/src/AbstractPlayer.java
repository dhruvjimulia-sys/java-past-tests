/**
 * This class provides a skeletal implementation of the Player interface. A complete implementation
 * is given for the methods addToHand(Card), pickup() and hasWon(). The discard() method calls an
 * abstract method selectCard() which implements the player's card selection strategy.
 *
 * <p>The developer need only subclass this abstract class and define the selectCard() method.
 */
