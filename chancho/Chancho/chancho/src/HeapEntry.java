 ...
 *
 * <p>1. It wraps an object.
 *
 * <p>2. It associates an integer called 'position' with the wrapped object.
 *
 * <p>3. It defines a natural ordering between HeapEntry<T> objects based solely on the value of the
 * 'position' field. The defined ordering follows the natural ordering on integers.
 *
 * <p>Note: this class has a natural ordering that is inconsistent with equals(..), i.e. For some
 * instances a, b of class HeapEntry, (a.equals(b)) is not the same as (a.compareTo(b)==0)
 */
