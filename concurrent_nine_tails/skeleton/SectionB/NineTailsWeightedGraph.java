/**
 * You must implement the <code>constructGraph</code> and <code>constructMinimumSpanningTree</code>
 * methods.
 */
public class NineTailsWeightedGraph {
  private static final int NUM_CONFIGURATIONS = 512;
  private static final int TERMINAL_CONFIGURATION_INDEX = 512;
  private ListInterface<PriorityQueueInterface<WeightedEdge>> configurations;
  private MinimumSpanningTree mst;

  /**
   * Constructs the weighted graph for the nine tails problem, and constructs the minimum spanning
   * tree starting from the target configuration.
   */
  ...
  /**
   * Returns a priority queue of weighted edges that correspond to the legal moves whose child is
   * the configuration with index equal to the given index
   *
  ...
  /**
   * Returns the wrapper object flipResult of the configuration generated by applying a legal move
   * to the given configuration index at the given position.
   *
   * <p>flipResult includes the index of the generated configuration and the number of flips
   *
   * @param confIndex index of the configuration to where a legal move is applied
   * @param position position in the string of Hs and Ts where the legal move is applied NB:
   *     position is 0-based
   */
  ...
  /**
   * Returns the configuration of coin's Hs and Ts that corresponds to a given index
   *
  ...
  /**
   * Returns the configuration index that corresponds to a given configuration of coin's Hs and Ts
   *
   * @param conf configuration of coin's of Hs and Ts NB: result is a 1-base integer
   */
  ...
  public void printParentsTest(int index) {
    ...
    PriorityQueue<WeightedEdge> parents =
        ((PriorityQueue<WeightedEdge>) configurations.get(index)).clone();
  ...
  /**
   * Print the shortest path from a given configuration, with index equal to the given source, to
  ...
  private class WeightedEdge implements Comparable<WeightedEdge> {
    ...
    public String toString() {
      return "Edge: parent=" + parent + ", child=" + child + ", weight=" + weight + ".";
    }
    ...
    public boolean equals(Object obj) {
      ...
      return (otherEdge.parent == this.parent
          && otherEdge.child == this.child
