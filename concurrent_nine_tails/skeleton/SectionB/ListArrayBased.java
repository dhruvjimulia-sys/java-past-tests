...
public class ListArrayBased<T> implements ListInterface<T> {
  ...
  /**
   * <strong>Implement this method for Question 1</strong> Adds the given new element at the given
   * position.
   *
  ...
  private void makeRoom(int givenPosition) {
    // shift right items at position >= givenPosition
    for (int pos = length; pos >= givenPosition; pos--) {
      list[translate(pos + 1)] = list[translate(pos)];
    }
  }
