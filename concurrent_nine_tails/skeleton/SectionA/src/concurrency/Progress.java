...
public class Progress {
  ...
  private static void testQuestion2() throws DeadlockException {
...

    {
      try {
        ...
        System.out.println(
            "MISMATCH: DeadlockException should have been thrown");
        mismatches++;
   ...
   * 1: wait(x, 0); wait(x, 0); wait(x, 0); y = 2; Thread 2: wait(x, 0); wait(x,
   * 0); wait(x, 0); y = 3; Thread 3: wait(x, 0); wait(x, 0); y = 4;
   * <p>
   * Uncomment this method as needed when you uncomment the test methods
   *
   * @return an example concurrent program
   ...
   */
  private static void checkExpectedVersusActual(String expected,
      String actual) {
