...
public class Progress {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("Progress program terminated with exception: " + e);
      System.exit(1);
    }
  ...
  private static void testQuestion1() {
    ...
    Stmt wait1 = new WaitStmt(new IdentifierExpr("a"), new IdentifierExpr("b"));
    Stmt wait2 = new WaitStmt(new IdentifierExpr("a"), new LiteralExpr(1));
  ...
  private static void testQuestion3() {
    ...
    {
      String result = new Executor(makeExampleProgram(), new RoundRobinScheduler()).execute();
    ...
    {
      String result = new Executor(makeExampleProgram2(), new RoundRobinScheduler()).execute();
      checkExpectedVersusActual(
    ...
    {
      String result = new Executor(makeExampleProgram3(), new RoundRobinScheduler()).execute();
      checkExpectedVersusActual(
  ...
  private static void testQuestion4() {
    ...
    {
      String result = new Executor(makeExampleProgram2(), new FewestWaitsScheduler()).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 1, y -> 1, z -> 1]\n"
              + "History: [3, 2, 2, 1, 1, 0]\n"
              + "Termination status: graceful\n",
    ...
    {
      String result = new Executor(makeExampleProgram3(), new FewestWaitsScheduler()).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 0]\nHistory: []\nTermination status: deadlock\n", result);
    }

    {
      String result = new Executor(makeExampleProgram4(), new FewestWaitsScheduler()).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 0, y -> 3]\n"
   ...
   *
   * <p>Store: { x == 0, y == 0 } Thread 0: x = 1; y = 2; Thread 1: x = 2; y = 3; Thread 2: wait(x,
   * 2); y = 4;
   *
   * <p>Uncomment this method as needed when you uncomment the test methods
   *
  ...
  private static ConcurrentProgram makeExampleProgram() {
    ...
    statements2.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(2)));
   ...
   *
   * <p>Store: { x == 0, y == 0, z == 0 } Thread 0: wait(z, 1); Thread 1: wait(y, 1); z = 1; Thread
   * 2: wait(x, 1); y = 1; Thread 3: x = 1;
   *
   * <p>Uncomment this method as needed when you uncomment the test methods
   *
  ...
  private static ConcurrentProgram makeExampleProgram2() {
    ...
    List<Stmt> statements0 = new ArrayList<Stmt>();
    statements0.add(new WaitStmt(new IdentifierExpr("z"), new LiteralExpr(1)));

    List<Stmt> statements1 = new ArrayList<Stmt>();
    statements1.add(new WaitStmt(new IdentifierExpr("y"), new LiteralExpr(1)));
    statements1.add(new AssignStmt("z", new LiteralExpr(1)));

    List<Stmt> statements2 = new ArrayList<Stmt>();
    statements2.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(1)));
  ...
  private static ConcurrentProgram makeExampleProgram3() {
    ...
    List<Stmt> statements0 = new ArrayList<Stmt>();
    statements0.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(1)));
   ...
   * <strong>Creates the following concurrent program:</strong>
   *
   * <p>Store: { x == 0, y == 0 } Thread 0: wait(x, 0); wait(x, 0); y = 1; Thread 1: wait(x, 0);
  ...
  private static ConcurrentProgram makeExampleProgram4() {
    ...
    List<Stmt> statements0 = new ArrayList<Stmt>();
    statements0.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements0.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements0.add(new AssignStmt("y", new LiteralExpr(1)));

    List<Stmt> statements1 = new ArrayList<Stmt>();
    statements1.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements1.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements1.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements1.add(new AssignStmt("y", new LiteralExpr(2)));

    List<Stmt> statements2 = new ArrayList<Stmt>();
    statements2.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements2.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements2.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements2.add(new AssignStmt("y", new LiteralExpr(3)));

    List<Stmt> statements3 = new ArrayList<Stmt>();
    statements3.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
    statements3.add(new WaitStmt(new IdentifierExpr("x"), new LiteralExpr(0)));
   ...
   */
  private static void checkExpectedVersusActual(Integer expected, Integer actual) {
   ...
   */
  private static void checkExpectedVersusActual(Boolean expected, Boolean actual) {
    checkExpectedVersusActual(expected.toString(), actual.toString());
  }
}
