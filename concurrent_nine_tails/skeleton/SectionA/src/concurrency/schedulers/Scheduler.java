...
public interface Scheduler {
  ...
  /**
   * Returns the next thread to be executed for the given program
   *
   * @param program the program for which a scheduling decision is required
  ...
  default void throwExceptionIfNoThreadsEnabled(ConcurrentProgram program)
