...
public class Store {
   ...
   *
   * @param name the variable to be queried
   ...
   *
   * @param name the variable to be updated
  ...
  private void checkVariableExists(String name) {
    if (!variables.containsKey(name)) {
      throw new IllegalArgumentException("Attempted lookup of unknown variable \"" + name + "\"");
    }
  }
}
