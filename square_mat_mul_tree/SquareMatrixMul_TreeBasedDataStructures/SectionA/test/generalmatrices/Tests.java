...
// Unused, but here to ensure that Java 8 or higher is used.
...
public class Tests {
  ...
  public void testQuestion1() {
    ...
    final Matrix<String> stringMatrix =
        new Matrix<>(Arrays.asList("a", "b", "c", "d", "e", "f", "g", "h", "i"));

    final Matrix<Integer> integerMatrix = new Matrix<>(Arrays.asList(1, 2, 3, 4));

    final Matrix<Matrix<Integer>> integerMatrixMatrix =
        new Matrix<>(
            Arrays.asList(
    ...
    try {
      ...
      throw new RuntimeException(
          "Expected IllegalArgumentException on attempt to create " + "empty matrix");
    ...
    assertEquals(
        "[[[[1 2][3 4]] [[2 3][4 1]]][[[3 4][1 2]] [[4 1][2 3]]]]", integerMatrixMatrix.toString());
  }
  ...
  public void testQuestion3() {
    ...
    final Matrix<Integer> integerMatrix1 = new Matrix<>(Arrays.asList(-1, 5, 8, -42));
    final Matrix<Integer> integerMatrix2 = new Matrix<>(Arrays.asList(2, 0, -4, 127));

    final Matrix<String> stringMatrix1 = new Matrix<>(Arrays.asList("hi", "fi", "wi", "fi"));
    final Matrix<String> stringMatrix2 = new Matrix<>(Arrays.asList("si", "fi", "py", "py"));

    final Matrix<Boolean> booleanMatrix1 =
        new Matrix<>(Arrays.asList(true, false, false, false, true, false, false, false, true));
    final Matrix<Boolean> booleanMatrix2 =
        new Matrix<>(Arrays.asList(true, false, true, false, true, false, true, true, false));

    final Matrix<Integer> integerMatrixMaxSum = integerMatrix1.sum(integerMatrix2, Math::max);
    ...
    final Matrix<String> stringMatrixProduct =
        stringMatrix1.product(stringMatrix2, String::concat, (a, b) -> a + "!" + b);
  ...
  public void testQuestion4() {
    ...
    final Matrix<PairWithOperators> productOfPairMatrices =
        Example.multiplyPairMatrices(pairMatrices);
